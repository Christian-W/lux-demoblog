...
function checkVersions() {
    return (tree, context) => {
        ...
        return util_1.waitForTreeCallback(tree, () => {
            const minimumLuxComponentsVersion = '1.8.2';
...
function updatePackageJson() {
    return (tree, context) => {
        logging_1.logInfoWithDescriptor('Aktualisiere LUX-Components Version auf 1.8.3.');
        return util_1.waitForTreeCallback(tree, () => {
            const newDependency = [
                { type: dependencies_1.NodeDependencyType.Default, version: '1.8.3', name: 'lux-components' },
...
function todosForUser() {
    return (tree, context) => {
        util_1.runInstallAndLogToDos(context, `Bitte starten Sie ${chalk_1.default.redBright('npm run smoketest')} um möglichen Fehlern vorzugreifen.`, `Weitere Informationen: https://confluence.gfi.ihk.de/display/AF/Update+Guide#UpdateGuide-UmstellungaufVersion1.8.3`);
        return tree;
    };
}
