...
function checkVersions() {
    return (tree, context) => {
        ...
        return util_1.waitForTreeCallback(tree, () => {
            ...
            validation_1.validateIhkGfiLuxComponentsVersion(tree, context, minimumLuxComponentsVersion);
...
function updatePackageJson() {
    return (tree, context) => {
        logging_1.logInfoWithDescriptor('Aktualisiere LUX-Components Version auf 1.8.6.');
        return util_1.waitForTreeCallback(tree, () => {
            const newDependency = {
...
function todosForUser() {
    return (tree, context) => {
        let version = '1.8.6';
        version = util_1.replaceAll(version, "\.", "");
        util_1.runInstallAndLogToDos(context, `Manuelle Schritte aus dem Update Guide (https://github.com/IHK-GfI/lux-components/wiki/Upate-Guide#version-${version}) durchführen!`);
        return tree;
    };
}
