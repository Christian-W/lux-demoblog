...
const index_1 = require("../../lux-version-1.7/1.7.10/index");
...
describe('lux-version-1.7.0', () => {
    ...
    describe(('[Rule] addThemingFolderThemes'), () => {
        it('Sollte den Theming-Ordner herüber kopieren', ((done) => __awaiter(this, void 0, void 0, function* () {
    ...
    describe(('[Rule] updateAngularJson'), () => {
        it('Sollte die Datei angular.json aktualisieren', ((done) => __awaiter(this, void 0, void 0, function* () {
            expect(JSON.parse(appTree.readContent('angular.json')).projects.bar.architect.lint).toBeDefined();
            schematics_1.callRule(index_2.updateAngularJson(), rxjs_1.of(appTree), context)
                .subscribe(() => {
                // Nachbedingungen prüfen
    ...
    describe(('[Rule] fixCompileError'), () => {
        it('Sollte MAT_PLACEHOLDER_GLOBAL_OPTIONS entfernen', ((done) => __awaiter(this, void 0, void 0, function* () {
            appTree.overwrite('/projects/bar/src/app/app.module.ts', appTree.readContent('/projects/bar/src/app/app.module.ts').replace('providers: []', `providers      : [
                {
            ...
            schematics_1.callRule(index_2.fixCompileError({ path: '/projects/bar' }), rxjs_1.of(appTree), context)
                .subscribe(() => {
                // Nachbedingungen prüfen
        ...
        it('Sollte die Provider nicht ändern', ((done) => __awaiter(this, void 0, void 0, function* () {
            appTree.overwrite('/projects/bar/src/app/app.module.ts', appTree.readContent('/projects/bar/src/app/app.module.ts').replace('providers: []', `providers      : [
    ...
    describe(('[Rule] addPackageJsonDependencies'), () => {
        it('Sollte die Dependencies hinzufügen', ((done) => __awaiter(this, void 0, void 0, function* () {
            ...
            schematics_1.callRule(index_2.addPackageJsonDependencies(), rxjs_1.of(appTree), context)
                .subscribe(() => {
                // Nachbedingungen prüfen
        ...
        it('Sollte die Dependencies nicht hinzufügen, wenn neuere vorhanden sind', ((done) => __awaiter(this, void 0, void 0, function* () {
    ...
    describe(('[Rule] addPackageJsonDevDependencies'), () => {
        it('Sollte die DevDependencies hinzufügen', ((done) => __awaiter(this, void 0, void 0, function* () {
            // Schreibe Fantasie-Versionen die älter sind in package.json
            appTree.overwrite('/package.json', '' +
                '{\n' +
                ' "devDependencies": {\n' +
            ...
            schematics_1.callRule(index_2.addPackageJsonDevDependencies(), rxjs_1.of(appTree), context)
                .subscribe(() => {
                // Nachbedingungen prüfen
        ...
        it('Sollte die DevDependencies nicht hinzufügen, wenn neuere vorhanden sind', ((done) => __awaiter(this, void 0, void 0, function* () {
            // Schreibe Fantasie-Versionen die aktueller sind in package.json
            appTree.overwrite('/package.json', '' +
                '{\n' +
                ' "devDependencies": {\n' +
    ...
    describe(('[Rule] addPackageJsonScripts'), () => {
        it('Sollte die Skripte hinzufügen', ((done) => __awaiter(this, void 0, void 0, function* () {
            ...
            schematics_1.callRule(index_2.addPackageJsonScripts({ project: 'bar' }), rxjs_1.of(appTree), context)
                .subscribe(() => {
                // Nachbedingungen prüfen
