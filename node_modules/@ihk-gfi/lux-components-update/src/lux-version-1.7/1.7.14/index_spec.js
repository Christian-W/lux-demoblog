...
describe('lux-version-1.7.14', () => {
    ...
    describe('[Rule] setupProject', () => {
        it('Sollte Fehler werfen, wenn ein empty Tree genutzt wird', () => {
            expect(() => runner.runSchematic('lux-version-1.7.14', {}, schematics_1.Tree.empty()))
    ...
    describe('[Rule] checkVersions', () => {
        it('Sollte einen Fehler werfen, wenn Version < n - 1', () => {
            ...
            schematics_1.callRule(index_1.checkVersions(), rxjs_1.of(appTree), context).subscribe((success) => expect(success).toBeUndefined(), (reason) => expect(reason.toString()).toContain('Dieser Generator benötigt allerdings die (neuere) Version 1.7.13.'));
        });
        it('Sollte einen Fehler werfen, wenn Version > n - 1', () => {
            test_helper_1.addDependencyToPackageJson(appTree, 'lux-components', '1.7.14');
            schematics_1.callRule(index_1.checkVersions(), rxjs_1.of(appTree), context).subscribe((success) => expect(success).toBeUndefined(), (reason) => expect(reason.toString()).toContain('Dieser Generator benötigt allerdings die (ältere) Version 1.7.13.'));
        });
        it('Sollte keinen Fehler werfen, wenn Version === n - 1', () => {
            test_helper_1.addDependencyToPackageJson(appTree, 'lux-components', '1.7.13');
    ...
    describe('[Rule] updatePackageJson', () => {
        ...
        it('Sollte die Dependency "lux-components" auf Version 1.7.14 setzen', ((done) => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('[Rule] updateModulesForCommonModule', () => {
        // Muss über async laufen, da sonst eine package.json geprüft wird, welche bereits wieder resettet wurde
        it('Sollte das "LuxCommonModule" in den Imports des Moduls ergänzen, wenn die component.html die richtigen Tags nutzt', ((done) => __awaiter(this, void 0, void 0, function* () {
            ...
            schematics_1.callRule(index_1.updateModulesForCommonModule({ path: '/projects/bar/' }), rxjs_1.of(appTree), context).subscribe(() => {
        ...
        it('Sollte das "LuxCommonModule" in den Imports des Moduls ergänzen, wenn die component.ts die richtigen Tags nutzt', ((done) => __awaiter(this, void 0, void 0, function* () {
            let moduleContent = appTree.readContent('/projects/bar/src/app/app.module.ts');
            expect(moduleContent.indexOf('LuxCommonModule')).toBe(-1);
        ...
        it('Sollte das "LuxCommonModule" NICHT in den Imports des Moduls ergänzen, wenn es bereits vorhanden ist', ((done) => __awaiter(this, void 0, void 0, function* () {
        ...
        it('Sollte das "LuxCommonModule" NICHT in den Imports des Moduls ergänzen, wenn weder component.ts noch component.html die richtigen Tags nutzt', ((done) => __awaiter(this, void 0, void 0, function* () {
            let moduleContent = appTree.readContent('/projects/bar/src/app/app.module.ts');
            expect(moduleContent.indexOf('LuxCommonModule')).toBe(-1);
            schematics_1.callRule(index_1.updateModulesForCommonModule({ path: '/projects/bar/' }), rxjs_1.of(appTree), context).subscribe(() => {
                moduleContent = appTree.readContent('/projects/bar/src/app/app.module.ts');
    ...
    describe('[Rule] updateModulesForErrorModule', () => {
        // Muss über async laufen, da sonst eine package.json geprüft wird, welche bereits wieder resettet wurde
        it('Sollte das "LuxErrorModule" in den Imports des Moduls ergänzen, wenn die component.ts die richtigen Tags nutzt', ((done) => __awaiter(this, void 0, void 0, function* () {
            let moduleContent = appTree.readContent('/projects/bar/src/app/app.module.ts');
            ...
            schematics_1.callRule(index_1.updateModulesForErrorModule({ path: '/projects/bar/' }), rxjs_1.of(appTree), context).subscribe(() => {
                moduleContent = appTree.readContent('/projects/bar/src/app/app.module.ts');
        ...
        it('Sollte das "LuxErrorModule" NICHT in den Imports des Moduls ergänzen, wenn es bereits vorhanden ist', ((done) => __awaiter(this, void 0, void 0, function* () {
            appTree.overwrite('/projects/bar/src/app/app.module.ts', `
        ...
        it('Sollte das "LuxErrorModule" NICHT in den Imports des Moduls ergänzen, wenn component.ts nicht die richtigen Tags nutzt', ((done) => __awaiter(this, void 0, void 0, function* () {
            let moduleContent = appTree.readContent('/projects/bar/src/app/app.module.ts');
            expect(moduleContent.indexOf('LuxErrorModule')).toBe(-1);
            schematics_1.callRule(index_1.updateModulesForErrorModule({ path: '/projects/bar/' }), rxjs_1.of(appTree), context).subscribe(() => {
                moduleContent = appTree.readContent('/projects/bar/src/app/app.module.ts');
