...
describe('lux-version-1.7.8', () => {
    ...
    describe('[Rule] updateLuxAppMenuLeft', () => {
        ...
        beforeEach(() => {
            ...
            appTree.overwrite('/projects/bar/src/app/app.component.html', '<lux-app-header>\n' +
        ...
        it('Das alte Appheadermenü sollte durch das neue Appheadermenü ersetzt sein.', () => {
            ...
            schematics_1.callRule(index_1.updateLuxAppMenuLeft({ path: '/projects/bar/src' }), rxjs_1.of(appTree), context).toPromise()
                .then(() => {
    ...
    describe('[Rule] updateLuxList', () => {
        ...
        beforeEach(() => {
            ...
            context = runner.engine.createContext(schematic);
            test_helper_1.addDependencyToPackageJson(appTree, 'lux-components', '1.7.7');
            appTree.overwrite('/projects/bar/src/app/app.component.html', '<lux-list [luxItems]="listItems" luxEmptyIconName="fa-times"\n' +
        ...
        it('Das Attribut "luxItems" sollte gelöscht sein', () => {
            ...
            // Änderungen durchführen
            schematics_1.callRule(index_1.updateLuxList({ path: '/projects/bar/src' }), rxjs_1.of(appTree), context).toPromise()
                .then(() => {
                // Nachbedingungen prüfen
    ...
    describe('[Rule] updateInterfaceNames', () => {
        ...
        beforeEach(() => {
            ...
            context = runner.engine.createContext(schematic);
            test_helper_1.addDependencyToPackageJson(appTree, 'lux-components', '1.7.7');
            appTree.overwrite('/projects/bar/src/app/app.component.ts', 'import { LuxMessage } from \'../../lux-layout/lux-message-box/lux-message-box-model/lux-message\';\n' +
        ...
        it('Die I-Präfixe für die Klassen LuxMessage, LuxMessageCloseEvent und LuxMessageChangeEvent sollten gesetzt sein.', () => {
            // Änderungen durchführen
            schematics_1.callRule(index_1.updateInterfaceNames({ path: '/projects/bar/src' }), rxjs_1.of(appTree), context).toPromise()
                .then(() => {
                // Nachbedingungen prüfen
    ...
    describe('[Rule] updateHammerConfig', () => {
        ...
        beforeEach(() => {
            ...
            context = runner.engine.createContext(schematic);
            test_helper_1.addDependencyToPackageJson(appTree, 'lux-components', '1.7.7');
            appTree.overwrite('/projects/bar/src/app/app.component.ts', 'import { LuxHammerConfig } from \'./lux-layout-model/lux-hammer-config\';\n' +
                '\n' +
                'providers: [\n' +
        ...
        it('LuxHammerConfig sollte in LuxComponentsHammerConfig umbenannt sein.', () => {
            // Änderungen durchführen
            schematics_1.callRule(index_1.updateHammerConfig({ path: '/projects/bar/src' }), rxjs_1.of(appTree), context).toPromise()
                .then(() => {
                // Nachbedingungen prüfen
                const modifiedContent = appTree.readContent('/projects/bar/src/app/app.component.ts');
    ...
    describe('[Rule] updateLuxTab', () => {
        ...
        beforeEach(() => {
            ...
            context = runner.engine.createContext(schematic);
            test_helper_1.addDependencyToPackageJson(appTree, 'lux-components', '1.7.7');
            appTree.overwrite('/projects/bar/src/app/app.component.html', '<lux-tab luxText="Hallo Welt 1">\n' +
                '    <ng-template>\n' +
                '      <h2>Hallo Welt</h2>\n' +
                '    </ng-template>\n' +
                '  </lux-tab>\n' +
        ...
        it('Das Attribut "luxText" sollte in "luxTitle" umbenannt sein', () => {
            ...
            // Änderungen durchführen
            schematics_1.callRule(index_1.updateLuxTab({ path: '/projects/bar/src' }), rxjs_1.of(appTree), context).toPromise()
                .then(() => {
                // Nachbedingungen prüfen
    ...
    describe('[Rule] updateLuxMenu', () => {
        ...
        beforeEach(() => {
            ...
            context = runner.engine.createContext(schematic);
            test_helper_1.addDependencyToPackageJson(appTree, 'lux-components', '1.7.7');
            appTree.overwrite('/projects/bar/src/app/app.component.html', ' <lux-menu [luxDisplayMenuLeft]="true" [luxDisplayExtended]="true" luxIconName="fa-ellipsis-h"\n' +
        ...
        it('Das Attribut "luxIconName" sollte in "luxMenuIconName" umbenannt sein', () => {
            ...
            // Änderungen durchführen
            schematics_1.callRule(index_1.updateLuxMenu({ path: '/projects/bar/src' }), rxjs_1.of(appTree), context).toPromise()
                .then(() => {
                // Nachbedingungen prüfen
    ...
    describe('[Rule] updateLuxStylesScss', () => {
        ...
        it('Die Datei "luxstyles" sollte ersetzt sein.', () => {
            ...
            // Änderungen durchführen
            schematics_1.callRule(index_1.updateLuxStylesScss({ path: '/projects/bar/' }), rxjs_1.of(appTree), context).toPromise()
                .then(() => {
                // Nachbedingungen prüfen
    ...
    describe('[Rule] setupProject', () => {
        it('Sollte Fehler werfen, wenn ein empty Tree genutzt wird', () => {
            expect(() => runner.runSchematic('lux-version-1.7.8', {}, schematics_1.Tree.empty()))
    ...
    describe('[Rule] checkVersions', () => {
        ...
        it('Sollte einen Fehler werfen, wenn Version !== n - 1', () => {
            test_helper_1.addDependencyToPackageJson(appTree, 'lux-components', '1.7.6');
    ...
    describe('[Rule] addAttributeTest', () => {
        ...
        beforeEach(() => {
            ...
            context = runner.engine.createContext(schematic);
            test_helper_1.addDependencyToPackageJson(appTree, 'lux-components', '1.7.7');
            appTree.overwrite('/projects/bar/src/app/app.component.html', '<lux-card luxTitle="Title" luxSubTitle="Subtitle" (luxClicked)="click()">\n' +
        ...
        it('Das Attribut "luxTest" sollte enthalten sein', () => {
            ...
            // Änderungen durchführen
            schematics_1.callRule(addAttributeTest({ path: '/projects/bar/src' }), rxjs_1.of(appTree), context).toPromise()
                .then(() => {
                // Nachbedingungen prüfen
    ...
    describe('[Rule] updateAttributeTest', () => {
        ...
        it('Das Attribut "updateAttributeTest" sollte geändert sein.', () => {
            ...
            expect(initContent).toContain('(luxLabel)="aaa"');
            // Änderungen durchführen
            schematics_1.callRule(updateAttributeTest({ path: '/projects/bar/src' }), rxjs_1.of(appTree), context).toPromise()
                .then(() => {
                // Nachbedingungen prüfen
                const modifiedContent = appTree.readContent('/projects/bar/src/app/app.component.html');
...
function updateAttributeTest(options) {
    return (tree, context) => {
        files_1.iterateFilesAndModifyContent(tree, options.path, (filePath, content) => {
            const info1 = html_1.addAttribute(content, 'lux-input', 'luxLabel', 'bbb');
            const info2 = html_1.addAttribute(info1.content, 'lux-input', '[luxLabel]', 'bbb');
            const info3 = html_1.addAttribute(info2.content, 'lux-input', '[(luxLabel)]', 'bbb');
            const info4 = html_1.addAttribute(info3.content, 'lux-input', '(luxLabel)', 'bbb');
...
function addAttributeTest(options) {
    return (tree, context) => {
        files_1.iterateFilesAndModifyContent(tree, options.path, (filePath, content) => {
            const info1 = html_1.addAttribute(content, 'lux-input', 'luxTest', 'aaa');
            const info2 = html_1.addAttribute(info1.content, 'lux-input', '[luxTest]', 'bbb');
            const info3 = html_1.addAttribute(info2.content, 'lux-input', '[(luxTest)]', 'ccc');
            const info4 = html_1.addAttribute(info3.content, 'lux-input', '(luxTest)', 'ddd');
            if (info1.updated || info2.updated || info3.updated || info4.updated) {
                tree.overwrite(filePath, info4.content);
            }
        }, '.html');
