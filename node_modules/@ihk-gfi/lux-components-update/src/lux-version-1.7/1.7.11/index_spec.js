...
describe('lux-version-1.7.11', () => {
    ...
    describe('[Rule] setupProject', () => {
        it('Sollte Fehler werfen, wenn ein empty Tree genutzt wird', () => {
            expect(() => runner.runSchematic('lux-version-1.7.11', {}, schematics_1.Tree.empty()))
    ...
    describe('[Rule] checkVersions', () => {
        it('Sollte einen Fehler werfen, wenn Version < n - 1', () => {
            ...
            schematics_1.callRule(index_1.checkVersions(), rxjs_1.of(appTree), context).subscribe((success) => expect(success).toBeUndefined(), (reason) => expect(reason.toString()).toContain('Dieser Generator benötigt allerdings die (neuere) Version 1.7.10.'));
        });
        it('Sollte einen Fehler werfen, wenn Version > n - 1', () => {
            test_helper_1.addDependencyToPackageJson(appTree, 'lux-components', '1.7.11');
            schematics_1.callRule(index_1.checkVersions(), rxjs_1.of(appTree), context).subscribe((success) => expect(success).toBeUndefined(), (reason) => expect(reason.toString()).toContain('Dieser Generator benötigt allerdings die (ältere) Version 1.7.10.'));
        });
    ...
    describe('[Rule] updatePackageJson', () => {
        ...
        it('Sollte die Dependency "lux-components" auf Version 1.7.11 setzen', ((done) => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('[Rule] renameLuxButtonProperty', () => {
        ...
        it('Sollte die Properties umbenennen', ((done) => __awaiter(this, void 0, void 0, function* () {
            ...
            schematics_1.callRule(index_1.renameLuxButtonProperty({ path: '/projects/bar/' }), rxjs_1.of(appTree), context).subscribe(() => {
    ...
    describe('[Rule] renameLuxCardContentExpanded', () => {
        ...
        it('Sollte die Tags umbenennen', ((done) => __awaiter(this, void 0, void 0, function* () {
            ...
            schematics_1.callRule(index_1.renameLuxCardContentExpanded({ path: '/projects/bar/' }), rxjs_1.of(appTree), context).subscribe(() => {
                appComponentContent = appTree.readContent('/projects/bar/src/app/app.component.html');
