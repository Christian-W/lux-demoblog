...
describe('lux-version-1.7.16', () => {
    ...
    describe('[Rule] setupProject', () => {
        it('Sollte Fehler werfen, wenn ein empty Tree genutzt wird', () => {
            expect(() => runner.runSchematic('lux-version-1.7.16', {}, schematics_1.Tree.empty()))
    ...
    describe('[Rule] checkVersions', () => {
        it('Sollte einen Fehler werfen, wenn Version < n - 1', () => {
            ...
            schematics_1.callRule(index_1.checkVersions(), rxjs_1.of(appTree), context).subscribe((success) => expect(success).toBeUndefined(), (reason) => expect(reason.toString()).toContain('Dieser Generator benötigt allerdings die (neuere) Version 1.7.15.'));
        });
        it('Sollte einen Fehler werfen, wenn Version > n - 1', () => {
            test_helper_1.addDependencyToPackageJson(appTree, 'lux-components', '1.7.16');
            schematics_1.callRule(index_1.checkVersions(), rxjs_1.of(appTree), context).subscribe((success) => expect(success).toBeUndefined(), (reason) => expect(reason.toString()).toContain('Dieser Generator benötigt allerdings die (ältere) Version 1.7.15.'));
        });
        it('Sollte keinen Fehler werfen, wenn Version === n - 1', () => {
            test_helper_1.addDependencyToPackageJson(appTree, 'lux-components', '1.7.15');
    ...
    describe('[Rule] updatePackageJson', () => {
        ...
        it('Sollte die Dependency "lux-components" auf Version 1.7.16 setzen', ((done) => __awaiter(this, void 0, void 0, function* () {
    ...
    describe(('[Rule] addPackageJsonDependencies'), () => {
        it('Sollte die Dependencies hinzufügen', ((done) => __awaiter(this, void 0, void 0, function* () {
            ...
            schematics_1.callRule(index_1.addPackageJsonDependencies(), rxjs_1.of(appTree), context)
                .subscribe(() => {
    ...
    describe(('[Rule] addPackageJsonDevDependencies'), () => {
        it('Sollte die DevDependencies hinzufügen', ((done) => __awaiter(this, void 0, void 0, function* () {
            ...
            schematics_1.callRule(index_1.addPackageJsonDevDependencies(), rxjs_1.of(appTree), context)
                .subscribe(() => {
                // Nachbedingungen prüfen
